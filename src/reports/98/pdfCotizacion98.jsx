...
//   const repuestosLu = cotizacion.repuestosLu;
...
//   const losRepuestos = repuestosLu.map((repu, index) => {
...
//               body: [['R U C N° 20602683321\n\nCOTIZACIÓN\n\n' + cerosALaIzquierda(cotizacion.correlativo, 8) + '\n']],
//             },
//             // text: [
...
//             margin: [0, 6, 0, 0],
//             // alignment: 'center',
//             text: { text: cotizacion.razonSocialNombreCliente, style: 'texto' },
//           },
//         ],
//       },
//       {
...
// export default pdfCotizacion98;
