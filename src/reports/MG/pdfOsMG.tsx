...
function pdfOsMG(os: any) {
  ...
  const losRepuestos = repuestosDespachados.map((repu: any, index: number) => {
    ...
    if (cantidadDespachada.$numberDecimal > 0) {
      ...
      return [
        ...
        { text: descripcionEquivalencia, style: 'tableBody' },
        {
          text: formatear_4Decimales(cantidadDespachada.$numberDecimal),
          style: 'tableBody',
        },
        { text: 'UNI', style: 'tableBody' },
        {
        ...
        {
          text: formatearMonedaPEN(cantidadDespachada.$numberDecimal * precioPEN.$numberDecimal),
          style: 'tableBody',
        },
      ];
    }
  ...
  const docDefinitios: any = {
    ...
    content: [
        ...
        columns: [
          ...
          },
          {
            ...
            table: {
              ...
              body: [['R U C N° 20602683321\n\nCOTIZACIÓN\n\n' + cerosALaIzquierda(os.correlativo, 8) + '\n']],
            },
            // text: [
      ...
      {
        columns: [
          { width: '16%', margin: [50, 6, 0, 0], text: { text: 'CLIENTE:', style: 'textoBold' } },
          {
            width: '44%',
            fontSize: 6,
            margin: [0, 6, 0, 0],
          ...
          { width: '16%', margin: [50, 6, 0, 0], text: { text: 'ESTADO:', style: 'textoBold' } },
          {
            width: '24%',
            fontSize: 6,
            margin: [0, 6, 0, 0],
      ...
      {
        columns: [
          { width: '16%', margin: [50, 6, 0, 0], text: { text: 'TECNICO:', style: 'textoBold' } },
          {
            width: '44%',
            fontSize: 6,
            margin: [0, 6, 0, 0],
          ...
          { width: '16%', margin: [50, 6, 0, 0], text: { text: 'TIPO:', style: 'textoBold' } },
          {
            width: '24%',
            fontSize: 6,
            margin: [0, 6, 0, 0],
      ...
      {
        columns: [
          { width: '18%', margin: [50, 6, 0, 0], text: { text: 'KM:', style: 'textoBold6' } },
          {
            width: '82%',
            fontSize: 6,
            margin: [0, 6, 0, 0],
            // alignment: 'center',
            text: { text: os.kilometraje, style: 'texto7' },
          },
        ],
      },
      {
        columns: [
          { width: '18%', margin: [50, 6, 0, 0], text: { text: 'MARCA-MODELO:', style: 'textoBold6' } },
          {
            width: '82%',
            fontSize: 6,
            margin: [0, 6, 0, 0],
            // alignment: 'center',
            text: { text: os.vehiculoMarca + ' - ' + os.vehiculoModelo, style: 'texto7' },
          },
        ],
      },
      {
        columns: [
          { width: '18%', margin: [50, 6, 0, 0], text: { text: 'PLACA:', style: 'textoBold6' } },
          {
            width: '82%',
            fontSize: 6,
            margin: [0, 6, 0, 0],
            // alignment: 'center',
            text: { text: os.placa, style: 'texto7' },
          },
        ],
      },
      {
        columns: [
          { width: '18%', margin: [50, 6, 0, 0], text: { text: 'VIN:', style: 'textoBold6' } },
          {
            width: '82%',
            fontSize: 6,
            margin: [0, 6, 0, 0],
            // alignment: 'center',
            text: { text: os.vin, style: 'texto7' },
          },
        ],
      },
