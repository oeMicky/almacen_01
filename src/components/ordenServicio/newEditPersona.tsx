...
export default component$((props: { soloPersonaNatural: boolean; personaSeleccio: any }) => {
  ...
  const grabando = $(async () => {
    ...
    ctx_docs_orden_servicio.graboPersona = true;
    ctx_docs_orden_servicio.mostrarPanelAgregarPersona0 = false;
  });
          ...
          <div class="form-control">
            ...
            <div class="form-control form-agrupado">
              <input
                ...
                onChange$={(e) => {
                  persona.numeroIdentidad = (e.target as HTMLInputElement).value.trim();
                }}
            ...
            <div class="form-control">
              ...
              <div class="form-control form-agrupado">
                <input
                  ...
                  // onChange={(e) => setRazonSocial(e.target.value.trim().toUpperCase())}
                />
              ...
              <div class="form-control">
                ...
                <div class="form-control form-agrupado">
                  <input
                    ...
                    //   onChange={(e) => setApellidoPaterno(e.target.value.trim().toUpperCase())}
                  />
                </div>
              </div>
              {/* //Ap Materno */}
