            ...
            <div class="form-control">
              ...
              <div class="form-control form-agrupado">
                <input
                  ...
                  value={definicion_CTX_COTIZACION.periodo}
                  // onInput$={(e) => {
              ...
              <div class="form-control form-agrupado">
                {definicion_CTX_COTIZACION.idSerieCotizacion !== '' ? (
                  <input
                    ...
                    // value={definicion_CTX_COTIZACION.serie + ' - ' + definicion_CTX_COTIZACION.numero}
                  />
                ) : (
                  <select
                  ...
                  >
                    ...
                    {dataSerie.value.map((ser: any) => {
                      return (
                        <option id={ser._id} value={ser.serie} selected={definicion_CTX_COTIZACION.serie === ser.serie}>
                          {ser.serie}
                        </option>
                      );
                    })}
              ...
              <div class="form-control">
                ...
                <div class="form-control form-agrupado">
                  <input
                    ...
                    type="text"
                    disabled
                    value={definicion_CTX_COTIZACION.numero}
                  />
                </div>
              </div>
            ) : (
                    ...
                    return (
                      <tr key={iTCotiServi.idAuxiliar}>
                        ...
                        <td data-label="Venta" style={{ textAlign: 'end' }}>
                          ...
                          {iTCotiServi.ventaPEN.$numberDecimal ? iTCotiServi.ventaPEN.$numberDecimal : iTCotiServi.ventaPEN}
                          {/* {iTCotiServi.ventaPEN
                            ? redondeo2Decimales(iTCotiServi.ventaPEN)
                            : redondeo2Decimales(iTCotiServi.ventaPEN.$numberDecimal)} */}
                        </td>
        ...
        <div>
          ...
          >
            ...
            {/* <button
              onClick$={() =>
                console.log(
                  'sumaTOTAL_REP_LUB - subTOTAL_REP_LUB - igvTOTAL_REP_LUB',
                  sumaTOTAL_REP_LUB,
                  subTOTAL_REP_LUB,
                  igvTOTAL_REP_LUB
                )
                  ...
                  {definicion_CTX_COTIZACION.repuestosLubri.map((iTRepuLubri: any, index: any) => {
                    ...
                    return (
                      <tr key={iTRepuLubri.idAuxiliar}>
                        ...
                        {/* <td data-label="Kx">{iTRepuLubri.idKardex}</td> */}
                        ...
                        <td data-label="Venta" style={{ textAlign: 'end' }}>
                          {/* {iTRepuLubri.ventaPEN.$numberDecimal ? iTRepuLubri.ventaPEN.$numberDecimal : iTRepuLubri.ventaPEN} */}
                          {/* {iTRepuLubri.ventaPEN ? iTRepuLubri.ventaPEN : redondeo2Decimales(iTRepuLubri.ventaPEN.$numberDecimal)} */}
                          {/* {iTRepuLubri.ventaPEN.$numberDecimal} */}
                          {/* {iTRepuLubri.ventaPEN} */}
                          {iTRepuLubri.ventaPEN.$numberDecimal ? iTRepuLubri.ventaPEN.$numberDecimal : iTRepuLubri.ventaPEN}
                          {/* {
                            (iTRepuLubri.ventaPEN =
                              typeof iTRepuLubri.ventaPEN !== 'undefined'
                                ? iTRepuLubri.ventaPEN.$numberDecimal
                                  ? iTRepuLubri.ventaPEN.$numberDecimal
                                  : iTRepuLubri.ventaPEN
                                : 0)
