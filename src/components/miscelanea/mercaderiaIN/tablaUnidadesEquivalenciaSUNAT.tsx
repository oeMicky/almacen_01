...
export default component$((props: { buscarUnidadesEquivalenciaSUNAT: number; cadenaABuscar: any; idLineaTipo: string; lineaTipo: string }) => {
  //#region CONTEXTO
  const ctx_new_edit_mercaderia_in = useContext(CTX_NEW_EDIT_MERCADERIA_IN);
  //#endregion CONTEXTO

  //#region BUSCANDO REGISTROS
  const lasUnidadesEquivalenciaSUNAT = useResource$<{ status: number; data: any; message: string }>(async ({ track, cleanup }) => {
