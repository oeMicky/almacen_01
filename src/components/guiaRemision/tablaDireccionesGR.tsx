                    ...
                    {misDireccionesGR.map((direcGR, index) => {
                      ...
                      return (
                        <tr key={direcGR._id}>
                          ...
                          <td data-label="Cod." class="comoCadena">
                            {direcGR.codEstablecimiento}
                          </td>
                            ...
                            <input
                              ...
                              onClick$={() => {
                                if (props.sentido === 'partida') {
                                  ...
                                  ctx_guia_remision.codEstablecimientoPartida = direcGR.codEstablecimiento;
                                ...
                                if (props.sentido === 'llegada') {
                                  ...
                                  ctx_guia_remision.codEstablecimientoLlegada = direcGR.codEstablecimiento;
