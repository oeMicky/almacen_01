...
import { getAsientoCompra, getIgvsCompra, inUpCompra } from '~/apis/compra.api';
...
export default component$(
  (props: { addPeriodo: any; compraSeleccionada: any; agenteRetencion: boolean; ejercicio: number; asientoC: any }) => {
    ...
    const definicion_CTX_COMPRA = useStore<ICompra>(
      {
        ...
        conFechaVencimiento:
          typeof props.compraSeleccionada.conFechaVencimiento !== 'undefined'
            ? props.compraSeleccionada.conFechaVencimiento
            : false,
        ...
        //****************************************** */
        //***************SOLES******************** */
        baseImponiblePEN: props.compraSeleccionada.baseImponiblePEN
          ? props.compraSeleccionada.baseImponiblePEN.$numberDecimal
          : '',
        ...
        //****************************************** */
        //***************DOLARES******************** */
        baseImponibleUSD: props.compraSeleccionada.baseImponibleUSD
          ? props.compraSeleccionada.baseImponibleUSD.$numberDecimal
          : '',
        ...
        retencionPorcentaje: props.compraSeleccionada.retencionPorcentaje
          ...
          : '',
        //***************REFERENCIA****************** */
        referenciaFecha: props.compraSeleccionada.referenciaFecha
          ? props.compraSeleccionada.referenciaFecha.substring(0, 10)
          : '',
    ...
    // const immutableObject = (parametrosGlobales) =>
    //   typeof parametrosGlobales === 'object'
    //     ? Object.values(parametrosGlobales).forEach(immutableObject) || Object.freeze(parametrosGlobales)
    //     : parametrosGlobales;
                  ...
                  <button
                    ...
                    onClick$={() => {
                      ...
                      if (elPlan.length === 1) {
                        ...
                        alert(
                          `El plan contable del ejercicio ${props.ejercicio} no existe. Pongase en contacto con el administrador.`
                        );
                        return;
                      }
                    }}
                        ...
                        {definicion_CTX_COMPRA.asientoContable.map((cuenta: any, index: number) => {
                          ...
                          return (
                            <tr key={cuenta.idAuxiliar}>
                              <td data-label="Ítem" key={cuenta.idAuxiliar} class="comoNumero">{`${cerosALaIzquierda(
                                indexItem,
                                3
                              )}`}</td>
